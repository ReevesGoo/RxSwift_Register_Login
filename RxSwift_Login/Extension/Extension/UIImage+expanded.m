...
- (UIImage *) imageWithWaterText:(NSString*)text font:(UIFont*)font inRect:(CGRect)rect
{
    ...
    //水印文字
    UIColor *color = [UIColor colorWithRed:38./255. green:136./255. blue:222./255. alpha:1];
    [color setFill];
...
#pragma clang diagnostic pop
    ...
    /// Set text alignment
        ...
        [text drawInRect:rect withAttributes:@{NSFontAttributeName:font,NSParagraphStyleAttributeName: paragraphStyle,NSForegroundColorAttributeName:color}];
    }
    UIImage *newPic = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
...
{
    return [self imageRotatedByDegrees:RadiansToDegree(radians)];
}
...
//return image;
//}
CGSize size = [self fitsize:targetSize];
UIGraphicsBeginImageContext(size);
...
return self.size;
CGFloat wscale = self.size.width/thisSize.width;
CGFloat hscale = self.size.height/thisSize.height;
...
-(UIImage *)blurryImage:(UIImage *)image1 withBlurLevel:(CGFloat)blur {
    ...
    CIImage *image = [[CIImage alloc] initWithImage:image1];
